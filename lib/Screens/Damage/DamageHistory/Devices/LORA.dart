...
class LoRaDamage extends StatefulWidget {
  const LoRaDamage({super.key});

  @override
  State<LoRaDamage> createState() => _LoRaDamageState();
}

class _LoRaDamageState extends State<LoRaDamage> {
