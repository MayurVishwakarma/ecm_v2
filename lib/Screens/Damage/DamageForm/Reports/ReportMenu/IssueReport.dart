...
class issueReports extends StatefulWidget {
  const issueReports({super.key});

  @override
  State<issueReports> createState() => _issueReportsState();
}

class _issueReportsState extends State<issueReports> {
  @override
  void initState() {
    super.initState();
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    Column(
                      mainAxisSize: MainAxisSize.min,
                      children: dp.issueProcess.map((subProcess) {
...
*/
                    if (dp.infoReports
                            ?.where((item) => item.reportedOn != null)
                            .isNotEmpty ??
                        false)
                      Container(
