...
class OfflineDamageManager extends StatefulWidget {
  static const routeName = "/OfflineDamageManager";
  const OfflineDamageManager({super.key});

  @override
  State<OfflineDamageManager> createState() => _DamageManagerState();
}

class _DamageManagerState extends State<OfflineDamageManager> {
