...
class DamageTabBarTool extends StatefulWidget {
  const DamageTabBarTool({super.key});

  @override
  State<DamageTabBarTool> createState() => _DamageTabBarToolState();
}

class _DamageTabBarToolState extends State<DamageTabBarTool> {
