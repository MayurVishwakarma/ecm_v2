...
// class DamageStatusManager extends StatefulWidget {
//   const DamageStatusManager({super.key});

//   @override
//   State<DamageStatusManager> createState() => _DamageStatusManagerState();
// }

// class _DamageStatusManagerState extends State<DamageStatusManager> {
//   @override
//   Widget build(BuildContext context) {
//     final ap = Provider.of<AuthProvider>(context);
//     return Scaffold(
//       appBar: AppBar(
//         title: customECMAppbar(context, "Damage Status", ap.selectedProject),
//       ),
//       body: Center(
...
import 'package:ecm_v2/Screens/Damage/DamageStatus/Devices/OMS.dart';
