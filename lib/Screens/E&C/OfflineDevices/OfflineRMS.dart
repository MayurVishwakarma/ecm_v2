...
class OfflineRms extends StatefulWidget {
  static const String routeName = '/offlineRms';
  const OfflineRms({super.key});

  @override
  State<OfflineRms> createState() => _OfflineRmsState();
}

class _OfflineRmsState extends State<OfflineRms> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: customECMAppbar(context, 'Offline-RMS', ap.selectedProject),
      ),
      body: SizedBox(
