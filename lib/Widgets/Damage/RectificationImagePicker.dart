...
class RectificationImagePicker extends StatefulWidget {
  final bool isEdit;
  const RectificationImagePicker({super.key, required this.isEdit});

  @override
  State<RectificationImagePicker> createState() =>
      _RectificationImagePickerState();
}

class _RectificationImagePickerState extends State<RectificationImagePicker> {
  @override
  Widget build(BuildContext context) {
    final dp = Provider.of<DamageProvider>(context);
    var imageList;
    imageList = dp.rectificationReport!
  ...
  Widget _buildImageListItem(dynamic imageItem) {
    return Container(
  ...
  String getImageTitle({dynamic item}) {
    try {
      var title = item.rectification ?? '';
      return title;
    } catch (e) {
      return 'Image';
    }
        ...
        content: Column(
          ...
          children: [
            ElevatedButton.icon(
              ...
              onPressed: () {
                Navigator.pop(context);
                provider.pickRectificationImage(
                  ImageSource.gallery,
                  imageItem,
                  context,
                );
