...
class DamageHistoryTile extends StatelessWidget {
  const DamageHistoryTile({super.key, required this.item, required this.index});

  final DamageHistoryModel? item;
  final int? index;
                ...
                children: [
                  Row(
                    children: [
                      Chip(
                        label: Text(
                          "${'Electrical'.tr()}: ${item?.electDamageList?.split(',').length ?? 0}",
                        ),
                      ...
                      Chip(
                        label: Text(
                          "${'Mechanical'.tr()}: ${item?.mechDamageList?.split(',').length ?? 0}",
                        ),
